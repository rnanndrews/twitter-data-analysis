...
public class TwitterProducerKafka
{
    ...
    // Setting up the keys for Twitter API
    String sAPIConsumerKey = "cS18x1zEJwbypZTpEGYCMLdXs";
    String sAPIConsumerSecret = "zUCz03N23ZFbJLEKjJQZYYU2UBu7pCS5Vjr6t8tL0dy3tEv5Vc";
    String sAPIToken = "1249345755095142401-3rPapcIdWUc6gaYMicASd6Gn9SdPP1";
    String sAPISecret = "6X0iUU4SKRZA34heqEQWP2axfojbsyYUw5FALv6APNpYP";
